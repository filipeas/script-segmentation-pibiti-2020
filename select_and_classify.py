...
def read_features_file():
    sp_file = open('/home/monstro/Documents/Workspace/Laravel/pibiti2020-api/public/storage/uploads/Script/saved_data/superpixels.npz', 'rb')
    sp_data = np.load(sp_file)
    ft_file= open('/home/monstro/Documents/Workspace/Laravel/pibiti2020-api/public/storage/uploads/Script/saved_data/features.npz', 'rb')
